  ...
  <div class="content-wrapper">
    ...
    <div style="margin-bottom: 20px">
      ...
      <div class="well" id="show_list">
        <?php $this->load->view('usuarios/item')?>
    </div>
</div>
</section>
</div>
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
              <span style="font-weight: bold;"> HOTEL/RESIDENCIA &nbsp;&nbsp;</span>
...
<div id="edit_usuario" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><i class="fa fa-plus-circle"></i>&nbsp;Modificar Usuario </h3>
      </div>
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
              <span style="font-weight: bold;"> HOTEL/RESIDENCIA &nbsp;&nbsp;</span>
              <select id="id_hotel_edit" class="form-control">
                  <?php foreach ($hoteles as $row){?>
                    <option value="<?php echo $row->id;?>"><?php echo $row->nombre;?></option>
                  <?php }?>
              </select>
          ...
          <div class="row">
             <div class="col-sm-12 col-md-12 col-lg-12">
                <span style="font-weight: bold;"> NIVEL&nbsp;&nbsp;</span>
                <select id="nivel_edit" class="form-control">
                  <option value="0">Administrador</option>
                  <option value="1">Usuario</option>
                </select>
              </div>
  ...
  function delUsuario(id){
    ...
    .then((willDelete) => {
      if (willDelete) {
            ...
            var url="index.php/Main/deleteUsuario?id="+id;  
            var URL=base+url;
            ajax.open("GET", URL);
...
function saveUser(){
    ...
    if( login!=""  ){
      if(password==re_password){
        ...
        divResultado = document.getElementById('show_list');  
          ajax=objetoAjax(); 
          var url="index.php/Main/saveUser?login="+login+"&password="+password+"&nivel="+nivel+"&email="+email+"&id_hotel="+id_hotel;         
          var URL=base+url;
          ajax.open("GET", URL);
          ajax.onreadystatechange=function() {
              if (ajax.readyState==4) {
  ...
  function setEdit(id, username, email, nivel , status, password){
  ...
  function editUser(){
    ...
    var nivel=document.getElementById("nivel_edit").value;
    ...
    if( login!=""  ){
      if(password==re_password){
        ...
        divResultado = document.getElementById('show_list');  
          ajax=objetoAjax(); 
          var url="index.php/Main/editUser?login="+login+"&password="+password+"&nivel="+nivel+"&email="+email+"&status="+status+"&id="+id_edit+"&pwd="+password_aux;         
          var URL=base+url;
          ajax.open("GET", URL);
          ajax.onreadystatechange=function() {
              if (ajax.readyState==4) {
