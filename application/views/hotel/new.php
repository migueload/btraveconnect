  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <div id="mensaje" class="alert alert-default" style="background-color: #CEECF5;margin-top: 20px">
        ...
        <div style="margin-top: -20px;color: #2f5aa6;">
            ...
            Puede ingresar la informaci&oacute;n del hotel y al finalizar hacer click en el boton <b>Guardar</b>.
        </div>
      </div>
    ...
    <section class="content" style="margin-top: 20px">
      ...
      <div style="margin-bottom: 10px;">
        <button class="btn btn-default btn-md" onclick="save()"><i class="fa fa-check-circle"></i>&nbsp;Guardar</button>
      </div>
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-info" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                	<?php $this->load->view('hotel/informacion');?>
                 </div> 
                <!-- fin  de tab de operadora-->
                  ...
                  <div class="tab-pane fade" id="custom-tabs-one-facilidades" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                  	<?php $this->load->view('hotel/facilidades');?>
                  </div>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-one-tarifas" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                  	<?php $this->load->view('hotel/tarifas');?>
                 </div>
                   <!-- fin  de tab de Hotel-->
...
<script type="text/javascript">
  ...
  function save(){
    ...
    if( (nombre!="") || (pais!=0) ){
        ...
        var URL="index.php/Main/saveHotel?nombre="+nombre+"&categoria="+categoria+"&pais="+pais+"&ciudad="+ciudad+"&email_reservas="+email_reservas+"&email_publico="+email_publico+"&codigo_postal="+codigo_postal+"&telefono="+telefono+"&hora_entrada="+hora_entrada+"&hora_salida="+hora_salida+"&habitaciones="+habitaciones+"&restaurantes="+restaurantes+"&descripcion="+descripcion+"&direccion="+direccion+"&latitud="+latitud+"&longitud="+longitud+"&facilidadesHot="+JSON.stringify(facilidadesHot)+"&facilidadesHab="+JSON.stringify(facilidadesHab);
        URL=base+URL;
        console.log(URL);
        ajax.open("GET", URL);  
        ajax.onreadystatechange=function() {
            if (ajax.readyState==4) {
             document.location.href=base+"index.php/Main/list_hotel";
